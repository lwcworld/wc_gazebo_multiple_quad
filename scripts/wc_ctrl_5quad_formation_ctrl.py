...
def local_position_callback_4(msg):
    agent4.state = msg
    agent4.state.pose.position.x = agent4.state.pose.position.x + 2
    agent4.state.pose.position.y = agent4.state.pose.position.y + 2

def local_position_callback_5(msg):
    agent5.state = msg
    agent5.state.pose.position.x = agent5.state.pose.position.x + 2
    agent5.state.pose.position.y = agent5.state.pose.position.y - 2
...
agent4 = Data_storage(idx_uav=4)
agent5 = Data_storage(idx_uav=5)
...
class setpoint_att(object):
    ...
    def calc_cmd_att_thr_auto(self, idx_uav): # offboard control autonomously (roll/pitch/yaw/throttle)
        ...
        X = np.array([agent1.state.pose.position.x, agent1.state.pose.position.y, agent1.vel_x, agent1.vel_y,
                      ...
                      agent4.state.pose.position.x, agent4.state.pose.position.y, agent4.vel_x, agent4.vel_y,
                      agent5.state.pose.position.x, agent5.state.pose.position.y, agent5.vel_x, agent5.vel_y])
